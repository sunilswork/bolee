 ...
 *
 */
public class JavaPutGet {

    // System exit status value (assume unset value to be 1)
    private static int status = 1;

    /**
     * jms_connection_factory_channel=LISA.SRV01
     * jms_connection_factory_transporttype=CLIENT
     * jms_connection_factory_queuemanager=EOWYN_A3
     * jms_connection_factory_hostname=eowyn-a3.it.volvo.net
     * jms_connection_factory_port=1437
     * jms_connection_factory_username=cs-ws-s-LISA
     * jms_queue_config_basequeuemanager=EOWYN_A3
     *
     * jms_queue_config_translationInqueue_basequeuename=LISA.APP.TRANSLATION.IN
     * jms_queue_config_confirmTranslationInQueue_basequeuename=LISA.APP.CONFIRMTRANSLATION.IN
     * jms_queue_config_orderTranslationOutQueue_basequeuename=LISA.APP.ORDERTRANSLATION.OUT
     */
